...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DW_WAKEUP_Pin|DW_SPIPOL_Pin|DW_SPIPHA_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DW_WAKEUP_Pin DW_SPIPOL_Pin DW_SPIPHA_Pin */
  GPIO_InitStruct.Pin = DW_WAKEUP_Pin|DW_SPIPOL_Pin|DW_SPIPHA_Pin;
