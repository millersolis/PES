...
#define PANIC_BTN_Pin GPIO_PIN_14
#define PANIC_BTN_GPIO_Port GPIOB
#define PANIC_BTN_EXTI_IRQn EXTI15_10_IRQn
#define LOCK_BTN_Pin GPIO_PIN_5
#define LOCK_BTN_GPIO_Port GPIOB
#define LOCK_BTN_EXTI_IRQn EXTI9_5_IRQn
